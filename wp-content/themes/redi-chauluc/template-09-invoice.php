<?php
/*
Template name: Template Ecommerce Invoice
...
<div class="container">
	<div class="row">
		<div class="col-lg-9 col-md-8">
			<h2 class="single-title3">Invoice</h2>	
			<form class="schedule-box">
				...
				<div class="quotation-row enter-hbl">
					<input type="text" name="company_name" placeholder="Please enter invoice no." autocomplete="off">
				</div>
